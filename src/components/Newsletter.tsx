          ...
          <div className="lg:col-span-5 bg-cream-dark p-8 md:p-12 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-0">
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="RECEIVE DAILY DISAPPOINTMENTS" className="flex-1 px-4 py-3 bg-background border border-border text-xs font-sans tracking-[0.1em] uppercase text-center placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" required />
